...
public class Main extends Application {
	...
	public void processKeyEvent(KeyEvent event) {
		...
		LevelControl control2 = new LevelControl();
		control2.setLevel(LevelFileReader.createFromFile("C:/Users/fredf/Documents/Coding/Year 2/group project/CS-230-grid/leveldef.txt",control2));
		String gridTile = LevelFileReader.levelToString(control2.getLevel());
		Tile [][] Tilegrid =control2.getTileGrid();
